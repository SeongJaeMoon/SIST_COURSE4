													...
													<form role="form">
														<div class="form-group">
															<input type="password" class="form-control input-sm"
																id="contentpw" name="pw" placeholder="패스워드 (4자리)"
																maxlength="4" required="required">
														</div>
														<!-- Ajax 요청을 위해 submit이 아닌 button으로 처리 -->
														<button type="button"
															class="btn btn-default btn-xs btn-pw" value="${q.qid}">Submit</button>

														<!-- jQuery 선택적 요소-->
														<div class="alert alert-danger alert-dismissible fade in"
															style="display: inline-block; display: none; padding-top: 5px; padding-bottom: 5px; margin: 0px;">
															<strong>Fail!</strong> 비밀번호가 불일치합니다.
														</div>
					...
					<div class="modal-body" style="padding: 40px 50px;">
						<form role="form" method="post"
							...
							<div class="form-group">
								...
								<label class="radio-inline"><input type="radio" name="grade" value = "1">강사</label> 
								<label class="radio-inline"><input type="radio" name="grade" value = "2" checked>수강생</label>
							</div>

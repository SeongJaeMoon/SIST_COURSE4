	...
	<div class="container" id="top">
		...
		<div class="panel page-header" style="text-align: center;">
			<h1 style="font-size: xx-large;">
				<a href="${pageContext.request.contextPath}/index.jsp"><img
					...
					alt="sist_logo.png"></a> 방명록 <small>v2.0</small> <span
		...
		<div class="panel panel-default" id="input">
			...
			<div class="panel-body">
				...
				<form action="${pageContext.request.contextPath}/views/guestbook/guestbookInsert.jsp"
					method="post">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="${pageContext.request.contextPath}/views/guestbook/guestbookDelete.jsp"
						method="post">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="${pageContext.request.contextPath}/views/login/login.jsp" method="post">

...
<%@ page import="java.util.*, com.test.domain.*, com.test.dao.*"%>
...
<%
	...
	for (int a = 0; a < picListLength; ++a) {
		...
		sb.append(String.format("<div class=\"col-md-3\"><div class=\"thumbnail\"><div style=\"padding-top:5px; padding-bottom:30px;\"><button type=\"button\" class=\"close btnDelete\" value=\"%s\">&times;</button> </div><a href=\"%s/resources/pictures/%s\" target=\"_blank\">", gb.getPid(), contextRoot, gb.getPicName())); 
		sb.append(String.format("<img src=\"%s/resources/pictures/%s\" alt=\"%s\" style=\"width: 100%%;\"></a>", contextRoot, gb.getPicName(), gb.getPicContent()));
	   ...
	   //->서버에 pid 값 GET 방식 전송
		$("button.btnDelete").on("click", function() {
			if (confirm("선택한 사진을 삭제하시겠습니까?")) {
				location.assign("<%=contextRoot%>/views/admin/adminpicturedelete.jsp?pid=" + $(this).val());
			}
		});
	...
	<div class="container">
		...
		<div class="panel page-header" style="text-align: center;">
			<h1 style="font-size: xx-large;">
				<a href="<%=contextRoot%>/views/admin/adminbooklist.jsp"><img src="<%=contextRoot%>/resources/img/sist_logo.png"
					alt="sist_logo.png"></a> 방명록 <small>v1.5</small> <span
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					<li><a href="<%=contextRoot%>/views/admin/adminbooklist.jsp">방명록 관리</a></li>
					<li class="active"><a href="<%=contextRoot%>/views/admin/adminpicturelist.jsp">사진 관리</a></li>
					<li><a href="<%=contextRoot%>/views/login/logout.jsp">[<%=name_%>/<%=id%>]로그 아웃
					</a></li>
				</ul>
			</div>
		</nav>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<%=contextRoot%>/views/admin/adminpictureinsert.jsp" method="post" enctype="multipart/form-data">
